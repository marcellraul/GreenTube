<template>
  <v-app id="inspire">
    <v-navigation-drawer v-model="drawer" app clipped>
        ...
        <v-list-item link  >
          <v-list-item-action>
            <v-icon class="ma-2" tile  color="teal">mdi-vuetify</v-icon>
          </v-list-item-action>
          <v-list-item-content>
        ...
        <v-list-item link href="/registro">
          <v-list-item-action >
...
<!--link href="/perfil/" -->
        <v-list-item   link href="/perfil" >
         ...
         <v-list-item link href="/perfil/usuarios">
          <v-list-item-action>
            <v-icon>mdi-account-group-outline</v-icon>
          </v-list-item-action>
          <v-list-item-content>
            <v-list-item-title>Tabla Users</v-list-item-title>
          </v-list-item-content>
        </v-list-item>

        <v-list-item link href="/perfil/tablavideos">
          <v-list-item-action >
            <v-icon>mdi-television</v-icon>
          </v-list-item-action>
          <v-list-item-content>
            <v-list-item-title>Tabla Videos</v-list-item-title>
          </v-list-item-content>
        </v-list-item>
        ...
        <v-list-item link>
          ...
          <v-list-item-content>
            <v-list-item-title>City Home</v-list-item-title>
          </v-list-item-content>
        </v-list-item>
        ...
        <v-list-item link>
          ...
          <v-list-item-content>
            <v-list-item-title>Cloud-Upload</v-list-item-title>
          </v-list-item-content>
        </v-list-item>
        ...
        <v-list-item link >
          ...
          <v-list-item-content>
            <v-list-item-title>Code tags</v-list-item-title>
          </v-list-item-content>
        </v-list-item>
        ...
        <v-list-item link>
          ...
          <v-list-item-content>
            <v-list-item-title>Wrench</v-list-item-title>
          </v-list-item-content>
        </v-list-item>
        ...
        <v-list-item link>
          ...
          <v-list-item-content>
            <v-list-item-title>List Square</v-list-item-title>
          </v-list-item-content>
        </v-list-item>
        ...
        <router-link :to="{ path: 'login' }" class="none">
            <v-list-item link >
              <v-list-item-action>
                <v-icon>mdi-help-box</v-icon>
              </v-list-item-action>
              <v-list-item-content>
                <v-list-item-title>Help Box</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
        </router-link>
